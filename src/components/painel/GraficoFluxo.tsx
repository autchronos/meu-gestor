    ...
    <div className="border border-borda bg-superficie">
      ...
      <div className="px-3 py-4">
        ...
        <div className="mt-3 flex items-center justify-between border-t border-borda px-2 pt-3 text-xs">
          ...
          <span className="tabular-nums text-texto-suave">Líquido do mês: <span className={`font-semibold ${liquido >= 0 ? "text-entrada" : "text-saida"}`}>{formatarBRL(liquido)}</span></span>
        </div>
      </div>
    </div>
  );
